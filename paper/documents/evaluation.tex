...
\begin{table}
  ...
  \begin{tabular}{|p{13em}|p{8em}|p{8em}|}
    ...
    Encrypted Media Extensions API & \cellcolor{green!25}対応 & \cellcolor{green!25}対応 \\ \hline
    ...
    Media Source Extensions API & \cellcolor{green!25}対応 & \cellcolor{green!25}対応 \\ \hline
  \end{tabular}
\end{table}
\begin{table}
