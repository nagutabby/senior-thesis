...
\begin{tabular}{rlr} \hline
  ...
  \multicolumn{1}{c}{ {\bfseries {活動時間[h]} }}
    \input{documents/activity_history.tex}
\end{tabular}
\end{center}
}}
\clearpage
...
\input{documents/related_research.tex}

\input{documents/method.tex}

\input{documents/evaluation.tex}

\input{documents/conclusion.tex}

\input{documents/acknowledgement.tex}
